...
Then in two separate tabs run `python app.py` and `webpack --watch`. Make edits to `js/Mainjsx` and `app.py` to edit the frontend and backend, respectively.
...
The entry point for the app is in `js/app.jsx`. The starter React component is `js/Mainjsx`. Editing this file is a good place to start.
